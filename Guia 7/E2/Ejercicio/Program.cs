...
namespace Ejercicio
{
    class Program
    {
        ...
        {
            //Dulce o truco! Se acerca jalogüin, y una empresa nos pidió un sistema que lleve el control de los sustos en una ciudad. 
            //A. Sustos
            ...
            //      Los adultos comunes sólo se asustan si tienen una tolerancia menor que la capacidad de susto del niño, y dan tantos caramelos como 
            //      la mitad de su tolerancia. La tolerancia se calcula como 10 * la cantidad de niños con más de 15 caramelos que intentaron asustarlo antes.
            ...
            //3.Nos informan que los niños han aprendido a formar legiones de legiones, es decir, legiones donde sus miembros pueden ser niños u otras legiones. 
            //Si es necesario hacer algún cambio para soportar este requerimiento, realizarlo. De lo contrario, explicar porqué es posible.
            ...
            //1. Hacer que un niño se coma una cantidad dada de caramelos. Si no tiene suficientes caramelos, su bolsa simplemente quedará vacia.
            //E. Indigestión (Bonus)
